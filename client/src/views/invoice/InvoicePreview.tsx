      ...
      >
        ...
        <section className="px-10 flex flex-row justify-between mb-8">
          <div className="w-1/2 pr-6 border-l-2 border-slate-100 pl-4 py-1">
            ...
            <div className="font-bold text-slate-800 text-[12px] mb-1">{data.sender.companyName || "VOTRE ENTREPRISE"}</div>
        ...
        {/* Footer */}
        <footer className="mt-8 py-5 border-t-4 bg-slate-50/80 px-10 text-center" style={{ borderTopColor: accentColor }}>
          ...
          <p className="mt-3 text-[8px] text-slate-300 uppercase tracking-widest">{data.footerNote || "Facture générée numériquement"}</p>
        </footer>
      </div>
    </div>
  );
