            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="flex h-16 items-center justify-center gap-3 rounded-3xl border-2 border-slate-200 bg-white px-8 text-lg font-bold text-slate-700 shadow-xl transition-all hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98]"
                >
          ...
          <section className="mt-40 relative overflow-hidden rounded-[4rem] bg-[#0A0F1C] px-8 py-24 text-center text-white shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                ...
                <button
                  onClick={handleGoogleLogin}
                  className="flex h-20 items-center justify-center gap-4 rounded-[2.5rem] bg-white px-10 text-xl font-black text-slate-900 shadow-xl transition-all hover:bg-slate-50 hover:scale-105 active:scale-95"
                >
